...
class UtilityMeter():
    ...
    async def influx_meter_writing(self):
        ...
        if tasks is None or len(tasks) == 0:
            ...
            flux =  '\n' \
                    '// Supply the new meter reading (in kWh) and run the task manually\n' \
                    'new_reading = 0\n' \
                    '\n' \
            ...
            try:
                tasks_api.create_task_every(name=task_name, flux=flux, every=f'10y', organization=organization)
